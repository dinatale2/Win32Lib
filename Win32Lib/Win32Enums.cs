...
namespace Win32Lib
{
    ...
    [Flags]
    public enum ToolTipMessages : int
    {
        ...
        TTM_RELAYEVENT = (WindowsMessages.WM_USER + 7),// Win7: wParam = GetMessageExtraInfo() when relaying WM_MOUSEMOVE
    ...
    //public enum WindowSizePosition : uint
    //{
    //  SWP_NOSIZE = 0x0001,
    //  SWP_NOMOVE = 0x0002,
    //  SWP_NOZORDER = 0x0004,
    ...
    ///<summary>
    /// The mouse event to be tracked with TrackMouseEvent
    ///</summary>
    [Flags]
    public enum TrackMouseEventFlag : uint
    {
